...
public class Controller_vehicle_repaired {
	...
	private ViewVehicleRepaired vvr;
	...
	public Controller_vehicle_repaired(Socket socket, ViewVehicleRepaired vvr){
		this.socket=socket;
		this.vvr=vvr;
						...
						public void actionPerformed(ActionEvent e){
							...
							if((JButton)e.getSource()==vvr.getOk()){
								...
								try {
									...
									out.println(EnumService.SEARCHVEHICLE.name());
									out.flush();
