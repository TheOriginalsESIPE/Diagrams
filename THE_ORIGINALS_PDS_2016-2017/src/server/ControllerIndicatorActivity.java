...
public class ControllerIndicatorActivity {
    ...
    /**
     * This method control() make reactions with the 3 buttons in view.
     * Confirme -> transfer the request map to the server, then receive the data from the server, analysing
