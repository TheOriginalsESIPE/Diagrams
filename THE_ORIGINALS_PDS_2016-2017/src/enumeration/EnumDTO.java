...
public enum EnumDTO {
    ...
    PIECE_STK("Piece_stockDTO", 7), REPAIRER("Repairer", 8), VEHICLE_WH("Vehicle_warehouse", 9), VEHICLE("VehicleDTO", 10),
    WH("WarehouseDTO", 11), INDICATOR("Indicator", 12), VISITINGMOTIF("VisitingMotifDTO", 13),  OPERATION("OperationDTO", 13);
