...
public class ViewDepotPieces extends JFrame{
	  ...
	  public ViewDepotPieces(){
	    ...
	    jta= new JTextArea(); 
	    jta.setBounds(550,170,300,150);  
	    jta1= new JTextArea(); 
	    jta1.setBounds(300,300,150,150); 
	    jta1.getScrollableTracksViewportHeight();
	    q = new JScrollPane(jta1,JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
	    q.setBounds(550,170,150,150);
	    k.add(a1);
	    k.add(a2);
	    k.add(a3);
	    k.add(label);
