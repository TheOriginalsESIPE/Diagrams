...
public class OperationAnais{
	...
	private String time_begin, date_begin, date_end, time_end, degre_emergency, login_repairer;
	private int id_breakdown;
	private VehicleDTO numMat;
	private int done;
	
	public OperationAnais(){
	}
	
	public OperationAnais(int io,String nm,String db,String de,String t,String dem,String lr,int ib, VehicleDTO numMat,int done){
