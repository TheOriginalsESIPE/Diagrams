...
import Client.controller.ControllerAnais;
import Server.dto.*;
...
public class Algo {
	...
	public void sortAlgorithm(boolean appel) throws SQLException {
		...
		for(int i = 0 ; i < tmp.size() ; i++) {
			...
			int note = 0; // note � 0 au debut et on l'incremente au fur et a mesure
			...
			// Traitement des degr�s d'urgence des op�rations
