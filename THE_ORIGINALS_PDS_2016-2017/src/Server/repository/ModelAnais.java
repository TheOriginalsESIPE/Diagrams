...
import Server.sql.MyConnectionPool;
...
// d�clenchement de l'algo apr�s ces m�thodes
		public class ModelAnais {
		 ...
		 //insertion d'une operation apr�s l'entree du vehicule
		...
		//celles en attente de pi�ces seront plac�es en derni�re dans la liste
