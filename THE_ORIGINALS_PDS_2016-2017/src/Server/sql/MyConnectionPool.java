	...
	*/
	...
	public class MyConnectionPool {
		...
		private Connection createNewConnectionForPool(){
			...
			String userName;
			String userPasswd;
			String fileName = "Server/properties/configDB.properties";

			input = getClass().getClassLoader().getResourceAsStream(fileName);
			if(input == null){
				System.out.println("Sorry, unable to find "+fileName);
			}
			//loading a Server.properties file
			try{
...
//			}
		...
		public synchronized void returnConnectionPool(Connection connection){
			//Adding the connection from the Client.client back to the connection pool
